export const HardWareChip = () => {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
                d="M12 3.75V2.25M15.75 3.75V2.25M8.25 3.75V2.25M12 21.75V20.25M15.75 21.75V20.25M8.25 21.75V20.25M20.25 12H21.75M20.25 15.75H21.75M20.25 8.25H21.75M2.25 12H3.75M2.25 15.75H3.75M2.25 8.25H3.75"
                stroke="#CCCCCC"
                stroke-width="1.4"
